...
def default_deep_dive_sections(symbol: str, profile: dict | pd.Series | None = None) -> list[dict]:
    return [
        {"section": "Business identity", "prompt": "这家公司到底卖什么，客户是谁，为什么现在重要？", "current_note": _profile_value(profile, "narrative")},
        {"section": "Fundamentals", "prompt": "收入、毛利、现金流是否已经兑现叙事？", "current_note": _profile_value(profile, "growth_evidence")},
        {"section": "Technicals", "prompt": "趋势、相对强弱、关键均线和成交量是否支持继续观察？", "current_note": ""},
        {"section": "Catalysts", "prompt": "未来 3-12 个月有什么事件可能改变市场认知？", "current_note": _profile_value(profile, "catalysts")},
        {"section": "Supply chain and peers", "prompt": "它在价值链中卡住了什么位置，替代品是谁？", "current_note": ""},
        {"section": "Narrative audit", "prompt": "哪些事实会证明我错了？市场共识可能在哪里过热？", "current_note": _profile_value(profile, "invalidation")},
    ]
